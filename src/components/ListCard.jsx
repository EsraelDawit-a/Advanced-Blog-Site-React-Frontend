    ...
    return (
        <div className=' mt-14  sm:flex px-5 justify-between w-11/12 lg:w-4/5 my-4 overflow-x-hidden'>
            ...
            <div className="content flex flex-col gap-1  ">
                ...
                <div>
                    <p className='font-[400] text-gray-500 text-sm mx-2  dark:text-gray-300 '>How you write your advertising copy will be based on where you will place your ad. If it’s a billboard ad, you’ll need a super catchy headline. </p>
                </div>
